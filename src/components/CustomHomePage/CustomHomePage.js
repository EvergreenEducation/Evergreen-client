...
function CustomHomePage() {
  ...
  let referenceRoute = window.location.href,isUrlCustomPage=window.location.href.indexOf("custom")> -1?true:false;
  ...
  const filterOffer = getOffers && getOffers.length && getOffers.map(item => {
...
export default withRouter(CustomHomePage);
