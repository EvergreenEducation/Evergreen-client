...
const TopicContainer = imported(() =>
  import('components/topic/TopicContainer')
);
const ProviderTypeContainer = imported(() =>
  import('components/provider/ProviderTypeContainer')
);
const SelectOptionsContainer = imported(() =>
  import('components/SelectOptionsContainer')
);
...
export default function AdminDashboardPage(props) {
  ...
  if (pathname === '/admin/providers') {
    ...
    FormContent = <ProviderCreationContainer closeModal={handleCancel} />;
    HeaderContent = () => (
      <SearchModalHeader
    ...
    MainContent = () => (
      <ProviderContainer handleTableData={handleTableDataForSearch} />
    );
  }
  ...
  if (pathname === '/admin/pathways') {
    ...
    FormContent = <PathwayCreationContainer closeModal={handleCancel} />;
    MainContent = () => (
      <PathwayContainer handleTableData={handleTableDataForSearch} />
    );
  }
